...
public class InGameHudMixin {
    ...
    private void drawTextureRedirect(DrawContext instance, Function<Identifier, RenderLayer> renderLayers, Identifier texture, int x, int y, int width, int height) {
        ...
        instance.centered_crosshair$drawTexture(renderLayers, CROSSHAIR_TEXTURE, Math.round((scaledCenterX - 7.5f) * 4) / 4f, Math.round((scaledCenterY - 7.5f) * 4) / 4f, 15, 15);
    }
}